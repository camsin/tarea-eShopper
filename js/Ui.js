          ...
          "<li style='border-bottom:  2px dashed lightgray;margin-bottom: 15px;'>"+
            "<div >"+
              ...
              "<p>Total:"+ (ti.usuario.carrito.listaEntradas[x].canti*ti.usuario.carrito.listaEntradas[x].producto.precio) +"</p>"+
							// '<button style="border:  none;color:  darkred;text-align: right;width:  100%;margin-bottom: 10px;"" prod="'+ ti.usuario.carrito.listaEntradas[x].producto.nombre +'" id="btnDelete' + x + '"></button>' +
            "</div>"+
          "</li>"
					);
			}
